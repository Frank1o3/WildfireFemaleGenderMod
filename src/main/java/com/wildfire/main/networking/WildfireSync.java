...
import com.wildfire.client.networking.ClientboundSyncPacket;
import com.wildfire.client.networking.SyncHelloPacket;
...
public final class WildfireSync {
	static public final Logger LOGGER = LogUtils.getLogger();
